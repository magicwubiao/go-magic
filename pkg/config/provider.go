...
func ListProviders() []ProviderInfo {
	return []ProviderInfo{
		...
		},
		{
			...
			Description:  "Claude 5 Sonnet/Opus - 强推理能力",
			Models:       []string{"claude-sonnet-5", "claude-fable-5", "claude-opus-5", "claude-haiku-4-5"},
			NeedsAPIKey:  true,
			NeedsBaseURL: false,
		},
		{
		...
		},
		{
			...
			Models:       []string{"MiniMax-M2.5", "MiniMax-M2"},
			NeedsAPIKey:  true,
			NeedsBaseURL: true,
		},
		{
			...
			Models:       []string{"llama3.3", "qwen3", "codellama", "mistral"},
			NeedsAPIKey:  false,
			NeedsBaseURL: true,
		},
		{
		...
		},
		{
			...
			Models:       []string{"glm-4.7", "glm-4.6", "glm-4-flash"},
			NeedsAPIKey:  true,
			NeedsBaseURL: true,
		},
		{
			...
			Models:       []string{"gemini-3.7-flash", "gemini-3.6-flash", "gemini-3.1-pro-preview"},
			NeedsAPIKey:  true,
			NeedsBaseURL: true,
		},
		{
		...
		},
		{
			...
			Models:       []string{"meta-llama/Llama-3.3-70B-Instruct-Turbo", "deepseek-ai/DeepSeek-V3"},
			NeedsAPIKey:  true,
			NeedsBaseURL: true,
		},
		{
			...
			Models:       []string{"mistral-large-latest", "mistral-small-3", "open-mistral-nemo"},
			NeedsAPIKey:  true,
			NeedsBaseURL: true,
		},
		{
			...
			Models:       []string{"command-a-03-2025", "command-r-plus-08-2024", "command"},
			NeedsAPIKey:  true,
			NeedsBaseURL: true,
		},
		{
