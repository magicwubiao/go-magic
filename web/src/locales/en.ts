export default {
  ...
  config: {
    ...
    skillsSaved: 'Skills config saved',
    ...
    autoSkillCreation: 'Auto Skill Creation',
    autoSkillCreationHint: 'Automatically create skills based on usage patterns',
    minPatternFrequency: 'Min Pattern Frequency',
  },
  models: {
