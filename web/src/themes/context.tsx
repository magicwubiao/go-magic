...
const STORAGE_KEY = "magic-dashboard-theme";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `magic_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "magic-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-magic-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-magic-theme-font", "true");
