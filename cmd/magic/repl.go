...
type REPL struct {
	...
	// Renderers
	mdRenderer   *skin.MarkdownRenderer   // Markdown renderer
	toolRenderer *skin.ToolCallRenderer   // Tool call renderer
	costRenderer *skin.CostRenderer      // Cost stats renderer
